...
parser.add_argument("--local_rank", default=0, type=int, help="do not set this argument")
...
parser.add_argument('--lewel-scale', default=0.1, type=float, help='scale factor of attention map')  # Updated to 0.1
...
parser.add_argument('--diversity_lambda', default=0.01, type=float, help='weight for diversity term in loss')  # Added
